...
class NotificationManager {
  ...
  /**
   * Either brings an existing EtherCore notification window into focus, or creates a new notification window. New
  ...
  /**
   * Closes a EtherCore notification if it window exists.
   *
   */
  closePopup () {
  ...
  /**
   * Checks all open EtherCore windows, and returns the first one it finds that is a notification window (i.e. has the
   * type 'popup')
   *
   * @private
