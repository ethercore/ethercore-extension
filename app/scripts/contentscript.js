...
// EtherCore Extension will be much faster loading and performant on Firefox.
...
async function setupStreams () {
  ...
  pump(
    ...
    pageStream,
    pageMux,
    (err) => logStreamDisconnectWarning('EtherCore Extension Inpage Multiplex', err)
  )
  pump(
    extensionMux,
    extensionStream,
    extensionMux,
    (err) => logStreamDisconnectWarning('EtherCore Extension Background Multiplex', err)
  )
...
function forwardTrafficBetweenMuxers (channelName, muxA, muxB) {
  ...
  pump(
    ...
    channelB,
    channelA,
    (err) => logStreamDisconnectWarning(`EtherCore Extension muxed traffic for channel "${channelName}" failed.`, err)
  )
}
...
function logStreamDisconnectWarning (remoteLabel, err) {
  let warningMsg = `EtherCore Extension - lost connection to ${remoteLabel}`
  if (err) warningMsg += '\n' + err.stack
...
function redirectToPhishingWarning () {
  console.log('EtherCore Extension - routing to Phishing Warning component')
