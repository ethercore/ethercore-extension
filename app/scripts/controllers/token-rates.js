...
class TokenRatesController {
  ...
  async updateExchangeRates () {
    ...
    const nativeCurrency = this.currency ? this.currency.state.nativeCurrency.toLowerCase() : 'ere'
    ...
    if (this._tokens.length > 0) {
      try {
        ...
        log.warn(`EtherCore Extension - TokenRatesController exchange rate fetch failed.`, error)
      }
    }
